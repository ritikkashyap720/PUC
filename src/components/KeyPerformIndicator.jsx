  ...
  const kpis = [
    {
      ...
      subtext: `${currencySymbol !== "SEK" ? currencySymbol : ""} -74,866 ${
        currencySymbol === "SEK" ? currencySymbol : ""
      } vs prev`,
    ...
    },
    {
      ...
      subtext: `of ${currencySymbol !== "SEK" ? currencySymbol : ""}${(
        currencyValue * budgetAmount
      ).toFixed(2)} ${currencySymbol === "SEK" ? currencySymbol : ""}`,
      valueColor: `${color}`,
      subtextColor: "text-gray-500",
    },
    {
      title: "Savings Opportunities",
      value: `${currencySymbol !== "SEK" ? currencySymbol : ""}707 ${
        currencySymbol === "SEK" ? currencySymbol : ""
      }`,
